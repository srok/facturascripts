...
use FacturaScripts\Dinamic\Model\NotaCreditoCliente;

/**
 * Controller to edit a single item from the NotaCreditoCliente model
 *
 * @author Carlos García Gómez      <carlos@facturascripts.com>
 * @author Luis Miguel Pérez        <luismi@pcrednet.com>
 * @author Rafael San José Tovar    <rafael.sanjose@x-netdigital.com>
 */
class EditNotaCreditoCliente extends SalesDocumentController
{
    ...
    protected function createViews()
    {
       ...
       // $this->createReceiptsView();
        ...
        //$this->addHtmlView('Refund', 'Tab/RefundNotaCreditoCliente', 'NotaCreditoCliente', 'refunds', 'fas fa-share-square');
    }
    ...
    {
        $invoice = new NotaCreditoCliente();
    ...
    protected function loadData($viewName, $view)
    {
        switch ($viewName) {
            ...
            case 'ListReciboCliente':
                $where = [new DataBaseWhere('idnotacredito', $this->getViewModelValue($this->getLineXMLView(), 'idnotacredito'))];
                $view->loadData('', $where);
                break;
    ...
    {
        $invoice = new NotaCreditoCliente();
        if (false === $invoice->loadFromCode($this->request->request->get('idnotacredito'))) {
            $this->toolBox()->i18nLog()->warning('record-not-found');
            return false;
        }
        ...
        $properties = [
            ...
            'idnotacreditorect' => $invoice->idnotacredito,
