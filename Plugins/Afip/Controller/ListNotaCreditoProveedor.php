...
/**
 * Controller to list the items in the NotaCreditoProveedor model
 *
 ...
 */
class ListNotaCreditoProveedor extends ListBusinessDocument
{
    ...
    {
        $this->createViewPurchases('ListNotaCreditoProveedor', 'NotaCreditoProveedor', 'nc');
        $this->createViewLines('ListLineaNotaCreditoProveedor', 'LineaNotaCreditoProveedor');
    ...
    protected function createViewPurchases(string $viewName, $modelName, $label)
    {
        ...
        // $this->addFilterCheckbox('ListNotaCreditoProveedor', 'pagada', 'unpaid', 'pagada', '=', false);
        // $this->addFilterCheckbox('ListNotaCreditoProveedor', 'idasiento', 'invoice-without-acc-entry', 'idasiento', 'IS', null);
        $this->addButtonLockInvoice('ListNotaCreditoProveedor');
    }
