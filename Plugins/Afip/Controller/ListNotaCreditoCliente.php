...
/**
 * Controller to list the items in the NotaCreditoCliente model
 *
 ...
 */
class ListNotaCreditoCliente extends ListBusinessDocument
{
    ...
    {
        $this->createViewSales('ListNotaCreditoCliente', 'NotaCreditoCliente', 'invoices');
        $this->createViewLines('ListLineaNotaCreditoCliente', 'LineaNotaCreditoCliente');
    ...
    protected function createViewSales(string $viewName, $modelName, $label)
    {
        ...
        $this->addFilterCheckbox('ListNotaCreditoCliente', 'pagada', 'unpaid', 'pagada', '=', false);
        $this->addFilterCheckbox('ListNotaCreditoCliente', 'idasiento', 'invoice-without-acc-entry', 'idasiento', 'IS', null);
        $this->addButtonLockInvoice('ListNotaCreditoCliente');
    }
