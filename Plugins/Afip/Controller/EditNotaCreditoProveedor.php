...
use FacturaScripts\Dinamic\Model\NotaCreditoProveedor;

/**
 * Controller to edit a single item from the NotaCreditoProveedor model
 *
 * @author Carlos García Gómez      <carlos@facturascripts.com>
 * @author Francesc Pineda Segarra  <francesc.pineda.segarra@gmail.com>
 * @author Rafael San José Tovar    <rafael.sanjose@x-netdigital.com>
 */
class EditNotaCreditoProveedor extends PurchaseDocumentController
{
    ...
    {
        return 'NotaCreditoProveedorDocumentLine';
    }
    ...
    protected function createViews()
    {
        ...
        // $this->addHtmlView('Refund', 'Tab/RefundNotaCreditoProveedor', 'NotaCreditoProveedor', 'refunds', 'fas fa-share-square');
    }
    ...
    {
        $invoice = new NotaCreditoProveedor();
